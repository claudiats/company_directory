<?php
	...
	$query = 'SELECT d.id, d.locationID, d.name as department, l.name as location FROM department d LEFT JOIN location l on (l.id = d.locationID) ORDER BY d.name, l.name';
